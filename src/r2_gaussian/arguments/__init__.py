...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.bhc_eta_ratio_lr_init = 0
        self.bhc_eta_ratio_lr_final = 0
        self.bhc_eta_ratio_lr_max_steps = 30000
        self.bhc_eta_thres_lr_init = 0
        self.bhc_eta_thres_lr_final = 0
        self.bhc_eta_thres_lr_max_steps = 30000
        self.bhc_gamma_lr_init = 0.0
        self.bhc_gamma_lr_final = 0.0
        self.bhc_gamma_lr_max_steps = 30_000     
        self.bhc_gamma_init_value = 10.0
